...
def main():
    """تابع اصلی با وب‌هوک برای Render"""
    # ساخت اپلیکیشن
    ...
    WEBHOOK_URL = os.environ.get('RENDER_EXTERNAL_URL', f'https://candidate-bot.onrender.com')
    
    logger.info(f"🚀 راه‌اندازی وب‌هوک روی {WEBHOOK_URL}")
